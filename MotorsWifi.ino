...
void setup() {
  ...
  // Initialize motor arrays - start with 3x3 configuration until we receive actual data
  ...
  switch(type) {
    ...
    case WStype_TEXT:
      ...
      if (doc.containsKey("config")) {
        ...
        numRows = doc["panels_y"];
        numColumns = doc["panels_x"];
        ...
        // We would reallocate the arrays here if the size changed,
        // but for simplicity we'll assume the max 3x3 configuration is already allocated
      }
